...
def experience():
    ...
    # Define experiences dynamically
    experiences = [
        {
            "title": "Software Engineer –– [Nextuple](https://www.linkedin.com/company/nextuple/) (PRESENT)",
            "description": """
                - Conducted A/B testing experiments to assess the effectiveness of various promotion strategies, resulting in a remarkable 24% increase in revenue.
                - Developed and implemented a machine learning model to predict customer churn, reducing churn rate by 20%.
                - Created a recommendation system using collaborative filtering, boosting customer engagement by 30%.
                - Designed and developed a dashboard to monitor key metrics and KPIs, enabling data-driven decision-making.
            """,
            "tools": """
        ...
        {
            "title": "Software Programmer –– [10Times](https://www.linkedin.com/company/10times-events/) (August 2021-October 2021)",
            "description": """
